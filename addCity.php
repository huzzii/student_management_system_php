...
if(isset($_POST['submit'])){
    ...
    try{        
        $sql = 'INSERT INTO CITY(sr_name, state_id) VALUES(:sname,:state)';
        $stmt = $pdo->prepare($sql);
        $stmt->execute(['sname' => $name, 'state' => $state]);
...
<div class="container-fluid px-1 px-md-5 px-lg-1 px-xl-5 py-5 mx-auto">
    <div class="card card0 border-0">
        ...
        <div class="row d-flex">
            <div class="col-lg-12">
                <div class="card1 pb-5">
                    <center><h1>Add City&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="city.php" class="btn btn-outline-warning">Go Back</a></h1></center>
